...
This file was generated by Claude Code AI assistant.
"""
...
def main():
    ...
    parser.add_argument("--output", "-o",
                       help="Output path for JWKS file (default: build/jwks.json)",
                       default="build/jwks.json")
    ...
    if args.from_existing:
        ...
        generate_jwks_from_existing_key(args.private_key, args.output)
    else:
        ...
        # Save private key in same directory as output
        private_key_path = os.path.join(output_dir or ".", "private_key.pem")
        save_private_key(private_key, private_key_path)

        # Create JWKS file
        jwks = create_jwks_file(public_key, args.output)

        print("\nGenerated files:")
        print(f"- {private_key_path}: Private key for signing JWTs")
        print(f"- {args.output}: Public key set for JWT verification")
